...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (cashDepositSelection == 4)
        {
            ...
            bool column1Same = slotMachine[0, 0] == slotMachine[1, 0] && slotMachine[1, 0] == slotMachine[2, 0];
            bool column2Same = slotMachine[0, 1] == slotMachine[1, 1] && slotMachine[1, 1] == slotMachine[2, 1];
            bool column3Same = slotMachine[0, 2] == slotMachine[1, 2] && slotMachine[1, 2] == slotMachine[2, 2];
